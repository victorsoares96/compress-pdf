...
```typescript
  ...
  const width = /* PDFNumber Width */ ...;
  const height = /* PDFNumber Height */ ...;
...
- Add fixture `scanned-bw.pdf` — synthetic PDF with CCITT G4 stream (generated by test setup script, not committed as binary)
